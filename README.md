...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ancient-band-aa58
```

A live public deployment of this template is available at [https://ancient-band-aa58.templates.workers.dev](https://ancient-band-aa58.templates.workers.dev)
